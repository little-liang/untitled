...
def sendmail_flag_today_func():
    with open("status.txt", "r") as f:
        sendmail_flag_today = f.read()
        if time_stamp == sendmail_flag_today:
...
def send_mail_func():
    ...
    print(sendmail_status_today)
    print(auto_java_DB_flag)
    ...
    msg['To'] = formataddr(["[receivers]: ", "sunzhen@hydsoft.com<sunzhen@hydsoft.com>,   lixiang<lixiang@hydsoft.com>,   xuyigang<xuyigang@hydsoft.com>sunzhen@hydsoft.com<sunzhen@hydsoft.com>,   lixiang<lixiang@hydsoft.com>,   xuyigang<xuyigang@hydsoft.com>"])
